...
const allDoctors = [
  ...
  },
  {
    ...
    available: true,
    experience: "6 Years",
    about: "Dr. Emily Larson specializes in women's health and reproductive medicine, providing comprehensive care with a compassionate approach.",
    fee: 60,
  },
  {
    id: "3",
    ...
    available: false,
    experience: "5 Years",
    about: "Dr. Sarah Patel is an expert in skin care and dermatological treatments, helping patients achieve healthy and radiant skin.",
    fee: 55,
  },
  {
    id: "4",
    ...
    available: true,
    experience: "8 Years",
    about: "Dr. Christopher Lee is dedicated to children's health, providing gentle and thorough care for infants to adolescents.",
    fee: 45,
  },
  {
    id: "5",
    ...
    available: true,
    experience: "10 Years",
    about: "Dr. Jennifer Garcia specializes in neurological disorders, offering expert diagnosis and treatment for complex conditions.",
    fee: 80,
  },
];
